...
##change color name below to call different color.  Switch function in node red will determine which copy/color of this file you will invoke with a voice command
 def main(self):
 try:
